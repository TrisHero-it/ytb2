            ...
            <div class="p-5">
                ...
                <div class="grid gap-4" style="grid-template-columns: repeat(auto-fill, minmax(320px, 1fr));">
                    @forelse ($families as $family)
                        ...
                        @endphp
                        <div class="kt-card" style="padding: 1.25rem; border-radius: 0.75rem;">
            ...
            function showFamilyHistory(familyId) {
                ...
                fetch('/api/families/' + familyId + '/history')
                    ...
                    .then(function (items) {
                        ...
                        var STATUS_META = {
                            add: { label: 'Thêm', dot: '#3b82f6', badgeBg: '#dbeafe', badgeColor: '#1d4ed8' },
                            change: { label: 'Sửa', dot: '#f59e0b', badgeBg: '#fef3c7', badgeColor: '#b45309' },
                            delete: { label: 'Xoá', dot: '#ef4444', badgeBg: '#fee2e2', badgeColor: '#b91c1c' },
                        };
